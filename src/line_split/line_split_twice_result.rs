...
/// [LineSplit::line_split_twice()](geo::algorithm::LineSplit::line_split_twice) method.
/// It can contain between one and three [Line](geo::Line)s / [LineString](geo::LineString)s.
/// 
