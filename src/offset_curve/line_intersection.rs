...
///
/// - `Line`: the type [geo::Line] which is actually a **segment**.
...
mod test {
    ...
    fn test_line_segment_intersection_with_parameters_parallel() {
        ...
        assert_eq!(line_segment_intersection_with_parameters(a, b, c, d), None)
    }
    #[test]
    ...
    fn test_line_segment_intersection_with_relationships() {
        ...
        let expected_intersection_point = Coord {
            x: 1f64 / 3f64,
            y: 4f64 / 3f64,
        };
