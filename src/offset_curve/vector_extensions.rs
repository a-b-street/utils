...
/// my changes to the [geo::algorithm::offset_curve] module at the moment.
///
/// The [geo::algorithm::Kernel] trait has some functions which overlap with
    ...
    Self: Copy,
{
    ...
    ///
    /// 3. The [geo::algorithm::Kernel::orient2d()] trait default
    ...
    /// anti-clockwise (Consistent with [geo::algorithm::rotate::Rotate]).
    fn left(self) -> Self;
